...
public class MiniFlaskParser extends Parser {
	...
	public static final int
		...
		RULE_routeDef = 4, RULE_routeMethod = 5, RULE_routeArgs = 6, RULE_routeArg = 7, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"file", "statement", "importStmt", "importNames", "routeDef", "routeMethod", 
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 34382281758L) != 0)) {
				{
				setState(71);
				_errHandler.sync(this);
	...
	public static class FlaskRouteDefinitionContext extends RouteDefContext {
		...
		public RouteMethodContext routeMethod() {
			return getRuleContext(RouteMethodContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class RouteMethodContext extends ParserRuleContext {
		public TerminalNode ROUTE() { return getToken(MiniFlaskParser.ROUTE, 0); }
		public TerminalNode GET() { return getToken(MiniFlaskParser.GET, 0); }
		public TerminalNode POST() { return getToken(MiniFlaskParser.POST, 0); }
		public RouteMethodContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_routeMethod; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniFlaskParserListener ) ((MiniFlaskParserListener)listener).enterRouteMethod(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniFlaskParserListener ) ((MiniFlaskParserListener)listener).exitRouteMethod(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniFlaskParserVisitor ) return ((MiniFlaskParserVisitor<? extends T>)visitor).visitRouteMethod(this);
			else return visitor.visitChildren(this);
		}
	}

	public final RouteMethodContext routeMethod() throws RecognitionException {
		RouteMethodContext _localctx = new RouteMethodContext(_ctx, getState());
		enterRule(_localctx, 10, RULE_routeMethod);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SuffixContext suffix() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 22278160L) != 0)) {
					{
					setState(248);
					routeArgKws();
					}
